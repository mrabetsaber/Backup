...
@Component({
  selector: 'app-updataserver',
  templateUrl: './updataserver.component.html',
  styleUrls: ['./updataserver.component.css']
})
export class UpdataserverComponent implements OnInit {
